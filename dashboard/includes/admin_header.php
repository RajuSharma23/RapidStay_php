            ...
            <div class="flex flex-col admin-sidebar rounded-r-lg overflow-hidden">
                        ...
                        <div class="w-20 h-20 rounded-full bg-white/20 p-1">
                            <div class="w-full h-full rounded-full overflow-hidden border-2 border-white flex items-center justify-center bg-white">
                                <?php if (isset($_SESSION['profile_image']) && !empty($_SESSION['profile_image'])): ?>
                                    <img src="<?php echo htmlspecialchars($_SESSION['profile_image']); ?>" alt="Profile" class="w-full h-full object-cover">
                                <?php else: ?>
                ...
                <div class="flex flex-col flex-1 overflow-y-auto px-3 py-6">
                    <nav class="flex-1 space-y-2">
                        <a href="../admin/index.php" class="flex items-center px-4 py-3 admin-nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'index.php' ? 'active shadow-md' : ''; ?>">
                        ...
                        <a href="../admin/user-management.php" class="flex items-center px-4 py-3 admin-nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'user-management.php' ? 'active shadow-md' : ''; ?>">
                            <span class="inline-flex items-center justify-center w-8 h-8 mr-3 <?php echo basename($_SERVER['PHP_SELF']) == 'user-management.php' ? 'bg-white text-primary rounded-lg' : 'text-white'; ?>">
                                <i class="fas fa-users"></i>
                            </span>
                            <span class="font-medium">User Management</span>
                        </a>
                        
                        <a href="../admin/pg-approval.php" class="flex items-center px-4 py-3 admin-nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'pg-approval.php' ? 'active shadow-md' : ''; ?>">
                            <span class="inline-flex items-center justify-center w-8 h-8 mr-3 <?php echo basename($_SERVER['PHP_SELF']) == 'pg-approval.php' ? 'bg-white text-primary rounded-lg' : 'text-white'; ?>">
                                <i class="fas fa-check-circle"></i>
                            </span>
                            <span class="font-medium">PG Approval</span>
                        </a>
                        
                        <a href="../admin/pg-listings.php" class="flex items-center px-4 py-3 admin-nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'pg-listings.php' ? 'active shadow-md' : ''; ?>">
                            <span class="inline-flex items-center justify-center w-8 h-8 mr-3 <?php echo basename($_SERVER['PHP_SELF']) == 'pg-listings.php' ? 'bg-white text-primary rounded-lg' : 'text-white'; ?>">
                                <i class="fas fa-home"></i>
                            </span>
                            <span class="font-medium">PG Listings</span>
                        </a>
                        
                        <a href="../admin/manage-bookings.php" class="flex items-center px-4 py-3 admin-nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'manage-bookings.php' ? 'active shadow-md' : ''; ?>">
                            <span class="inline-flex items-center justify-center w-8 h-8 mr-3 <?php echo basename($_SERVER['PHP_SELF']) == 'manage-bookings.php' ? 'bg-white text-primary rounded-lg' : 'text-white'; ?>">
                                <i class="fas fa-calendar-check"></i>
                            </span>
                            <span class="font-medium">Bookings</span>
                        </a>
                        
                        <a href="../admin/roommates.php" class="flex items-center px-4 py-3 admin-nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'roommates.php' ? 'active shadow-md' : ''; ?>">
                        ...
                        <a href="../admin/settings.php" class="flex items-center px-4 py-3 admin-nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'settings.php' ? 'active shadow-md' : ''; ?>">
                            <span class="inline-flex items-center justify-center w-8 h-8 mr-3 <?php echo basename($_SERVER['PHP_SELF']) == 'settings.php' ? 'bg-white text-primary rounded-lg' : 'text-white'; ?>">
            ...
            <div class="relative flex-1 flex flex-col max-w-xs w-full admin-sidebar transform transition ease-in-out duration-300">
                ...
                <div class="flex-1 h-0 overflow-y-auto">
                    <nav class="px-2 py-4 space-y-1">
                        <a href="../admin/index.php" class="flex items-center px-4 py-2 admin-nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'index.php' ? 'active' : ''; ?>">
            ...
            <header class="admin-header shadow-sm z-10">
                <div class="flex items-center justify-between px-4 py-3">
                    ...
                    <div class="flex items-center space-x-4">
                                ...
                                <div class="max-h-60 overflow-y-auto">
                                    <a href="#" class="block px-4 py-3 text-sm hover:bg-gray-100 border-b">
                                        <div class="flex items-start">
                                            ...
                                            <div>
                                                <p class="font-medium text-primary">New listing approval requested</p>
                                                <p class="text-xs text-gray-500 mt-1">Owner John Doe has submitted a new PG listing for approval</p>
                        ...
                        <!-- Messages dropdown with similar styling as notifications -->
                        <div class="relative dropdown-container">
                            <button class="p-2 text-primary hover:text-primary-dark focus:outline-none" id="message-button">
                                <i class="fas fa-envelope"></i>
                            </button>
                            
                            <!-- Messages Dropdown -->
                            <div id="messages-dropdown" class="dropdown-menu hidden">
                                <div class="px-4 py-2 border-b flex justify-between items-center bg-primary text-white">
                                    <h3 class="font-medium">Messages</h3>
                                </div>
                                <!-- Messages content -->
                                <div class="border-t">
                                    <a href="../admin/messages.php" class="block px-4 py-2 text-sm text-center text-primary hover:bg-gray-100">
                                        View all messages
                                    </a>
                                </div>
                            </div>
                            ...
                            <button type="button" class="flex items-center focus:outline-none" id="header-user-menu-button">
                                <div class="flex-shrink-0 h-10 w-10 relative">
                                    <div class="h-full w-full rounded-full overflow-hidden bg-primary bg-opacity-10 flex items-center justify-center">
                                        <?php if (isset($_SESSION['profile_image']) && !empty($_SESSION['profile_image'])): ?>
                                            <img src="<?php echo htmlspecialchars($_SESSION['profile_image']); ?>" alt="Profile" class="h-full w-full object-cover">
                                        <?php else: ?>
                                ...
                                <div class="ml-3">
                                    ...
                                    <div class="text-sm font-medium text-gray-500">
                                        <?php echo isset($_SESSION['user_email']) ? htmlspecialchars($_SESSION['user_email']) : 'admin@example.com'; ?>
                                    </div>
                                </div>
